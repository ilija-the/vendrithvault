...
Campaigns are the many stories of games that have taken place in Vendrith. Some are short, sometimes called oneshots, whereas others can last as long as years. Most campaigns have a party of adventurers, villains, and themes.
 ...
 > In the folder structure of the vviki, the Campaigns folder contains all notes documenting specific campaigns and oneshots (as listed here), the player characters that played in them, the parties they formed, and other assorted useful things like a campaign timeline, possible homebrew options and variant rules, etc.
