...
Campaigns are the many stories of games that have taken place in Vendrith. Some are short, sometimes called oneshots, whereas others can last as long as years. Most campaigns have a party of adventurers, villains, and themes.
 ...
 > In the folder structure of the vviki, the >Campaigns folder contains all notes documenting specific campaigns and oneshots (as listed here), the player characters that played in them, the parties they formed, and other assorted useful things like a campaign timeline. Each campaign note should also point to variant rules, homebrew player options and such through links, which should be stored in the >Admin folder.
...
> 🎵 [Theme of Impending War](https://youtu.be/pzqtLZ23S5Q)
...
#campaigns/circles
**Setting:** Philosophia, 1266, Freezy 1-30th
...
#### Forgotten Dawn - Talvan Megadungeon
#campaigns/forgotten-dawn
