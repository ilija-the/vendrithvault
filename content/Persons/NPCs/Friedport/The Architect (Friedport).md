...
Still trying to realise the Labyrinthine plan, the Architect looked for people to kill Amelie and take over the sisterhood from the inside so, once inviting [[z_Other Campaigns/3.1 Landcrab Plot/Bande Aparte]] to do so. Rejected, the twins have fought the [[Newcomers of Friedport]] on multiple occasions. One such occasion was at the [[Riseagain Tower]], an enormous wooden tower the Architect realised the plans for based on the [[Amurrun Markings]] of [[Valfrid Veldaks]]. Here, they killed [[Mag Gafn]], a goblin inventor fraud that had received the credit for the tower, but failed to kill [[Ashur Holdok]] and [[Gator Grippli]]. Later, Ashur Holdok installed a plaque honouring the Architect as the building's actual planner on the tower.