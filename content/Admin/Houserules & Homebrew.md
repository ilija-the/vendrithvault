...
- **Riskier Firearms.** Firearms may be made more of a gamble to use. They gain an additional damage die as a baseline (though this doesn't increase the amount you gain from striking runes, which still only add 1 extra per tier), the Kickback trait deals 2 additional damage instead of 1, and the Deadly and Fatal traits each add 1 more damage die. As a trade-off, the weapon can always [misfire ](https://2e.aonprd.com/Rules.aspx?ID=1649), which you have to roll a DC 5 flat check for on a Critical Failure. If you have a Redpowder Weapon or a stolen Titan-Worshipper's firearm as a non-worshipper, you have to roll on a failure as well.
