...
- **Crafting Lores.** Potentially more of a clarification than a homebrew. So long as you meet the prerequisites in Crafting to Craft an item otherwise, you can use a Lore like "glassworking" or even "metalworking" or "alchemy" lore to craft said item, gaining a reduction in the DC for it. "Blacksmithing," "Alchemy" and "Magical Crafting" or something similar is so broad it can only ever give a -2 DC. Specific Crafting Lores like the rest found in [Specialty Crafting](https://2e.aonprd.com/Feats.aspx?ID=5216) and similar are specific enough they can give the full -5 DC.
> This allows you toalso stacks neatly with the Specialty Crafting feat.
