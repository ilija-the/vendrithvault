...
While slot spellcasters primarily view essence as a more raw, basic form of magic that can be studied as a form of mastering the fundamentals such as cantrips, Vilhunian students primarily focus on translating complex (and to them, woefully inefficient) Mogxian spells to become castable via essence methods on the fly.