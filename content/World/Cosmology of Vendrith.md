...
The most used and endorsed framework to understand and study planes nowadays is the [[Great Flow|Great Flow Theory]], which posits that all planes exist in various spots on a downward spiral, in which all is created at the top in [[Azure]] and all is destroyed at the bottom in [[Abbadon]].
