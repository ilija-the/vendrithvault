...
The starting point of Cosmology may have been the [[Mythos of Vendrith]]. The most used and endorsed framework to understand and study planes nowadays is the [[Great Flow|Great Flow Theory]], which posits that all planes exist in various spots on a downward spiral, in which all is created at the top in [[Azure]] and all is destroyed at the bottom in [[Abbadon]].

Planet is a term used for planes that are visible in the [[Sky|night or day sky]].
...
- [[Yond]], an enormous dark planet almost always visible above.
-  The [[Rustyard]], a mysterious plane thought to inhabit forgotten dreams and memories.
- [[Deep Gray]], a mysterious plane that may be related to [[Gnomes]].
- The [[Feydark]], a mysterious plane that may be related to the Deep Gray and Gnomes.